    ...
    <>
      <section className='dark:bg-darkmode pt-8 md:pb-24 pb-16'>
        <div className='container mx-auto max-w-6xl px-4'>
          <div className='flex md:flex-row flex-col md:items-center items-start justify-center'>
          ...
          <div className='md:pt-32 pt-11 md:pb-28 pb-8'>
            <iframe
              src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4015721.649!2d74.8584!3d10.1632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7c2c3d4e5f6%3A0x1234567890abcdef!2sKerala%2C%20India!5e0!3m2!1sen!2sin!4v1715676641521!5m2!1sen!2sin'
              width='1114'
              height='477'
              loading='lazy'
              referrerPolicy='no-referrer-when-downgrade'
              className='rounded-lg w-full'
              title='Edakkazhiyur, Thrissur Location'></iframe>
          </div>
        </div>
