                        ...
                        <div className='flex'>
                          <div className='flex flex-col justify-between gap-2 mt-2'>
                            {Counts.slice(0, 26).map((item, index) => {
                              return (
                                <p key={`separator-${index}`} className='text-xl text-black dark:text-white/50'>
                                  |
                                </p>
                              )
                            })}
                              ...
                              <div className='flex'>
                                <div className='flex flex-col justify-between gap-2 mt-2'>
                                  {Counts.slice(0, 20).map((item, index) => {
                                    return (
                                      <p key={`separator-20-${index}`} className='text-xl text-black dark:text-white/50'>
                                        |
                                      </p>
                                    )
                                  })}
                                    ...
                                    <div className='flex'>
                                      <div className='flex flex-col justify-between gap-2 mt-2'>
                                        {Counts.slice(0, 10).map((item, index) => {
                                          return (
                                            <p key={`separator-10-${index}`} className='text-xl text-black dark:text-white/50'>
                                              |
                                            </p>
                                          )
                                        })}
                                    ...
                                    <div className='flex'>
                                      <div className='flex flex-col justify-between gap-2 mt-2'>
                                        {Counts.slice(0, 2).map((item, index) => {
                                          return (
                                            <p key={`separator-2-${index}`} className='text-xl text-black dark:text-white/50'>
                                              |
                                            </p>
                                          )
                                        })}
                                    ...
                                    <div className='flex'>
                                      <div className='flex flex-col justify-between gap-2 mt-2'>
                                        {Counts.slice(0, 1).map((item, index) => {
                                          return (
                                            <p key={`separator-1-${index}`} className='text-xl text-black dark:text-white/50'>
                                              |
                                            </p>
                                          )
                                        })}
