        ...
        <div className='grid md:grid-cols-12 items-center gap-7'>
          ...
          <div
            ...
            <p className='text-gray dark:text-white/70 text-base font-semibold'>
              With 5+ years of experience, I specialize in creating end-to-end web solutions with modern technologies. 
              From responsive frontends to scalable backends, I bring ideas to life with clean code and best practices.
            </p>
